...
<head>
    ...
    <title>Se rendre au BTS CRSA</title> <!-- Titre de page -->
...
$message_erreur = "";
$page_origine = "serendreBTSCRSA.php?idpage=FH1uBdD";
if (isset($_GET["idpage"])) {
    $idpage = $_GET["idpage"];
    $url = $_SERVER['REQUEST_URI'];
    $erreur = "Erreur : Vous ne pouvez pas modifier L'url";
    $controle = "/serendreBTSCRSA.php?idpage=FH1uBdD"; // Notez l'ajout du slash pour la comparaison correcte du chemin
    if ($url != $controle) {
      ...
      <section class="row"> <!-- les trois éléments suivant seront répartis en rang [ELEM 1; ELEM 2; ELEM 3;]  -->
        ...
        <div class="slider col-12 col-md-12 col-lg-10" id="slider"> <!--ELEM 2 PREND 10 Colones lors ce que le ratio écran est 16/9, sinon toute la largeur dispo | SLIDER D'IMAGES -->
          <section class="d-flex justify-content-center"> <!-- Aligner les éléments suivant au centre -->
            ...
            <img src="images/Orientation/GIFS/ORIENTATION_CRSA_2.gif" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/GIFS/ORIENTATION_CRSA_3.gif" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/GIFS/Orientation_CRSA_FIN.gif" class="img-fluid slider-image" id="image" alt="responsive-image">                        
            <button type="button" class="btn btn-light hidden w-100 btn-custom" id="arrived" style="border: 2px solid black; border-radius: 10px; margin-bottom: 10px;">
                <a class="h3 text-dark d-block" href="btsCRSA.php?idpage=FH1uBdD">Cliquez ici pour confirmer votre présence</a>
