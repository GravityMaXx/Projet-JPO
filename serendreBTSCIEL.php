...
<head>
    ...
    <title>Se rendre au BTS CIEL</title>
...
if (isset($_GET["idpage"])) {
    ...
    $controle = "/serendreBTSCIEL.php?idpage=FH1uxrm"; // Notez l'ajout du slash pour la comparaison correcte du chemin
    if ($url != $controle) {
...
<?php else: ?>
    ...
    <main>
        <div class="container-fluid" style="margin-top: 20px;">
            ...
            <section class="row"> 
                ...
                <div class="slider col-12 col-md-12 col-lg-10" id="slider">
                    <section class="d-flex justify-content-center">
                        <img src="images/Orientation/GIFS/ORIENTATION_DEBUT_COMMUN.gif" class="active img-fluid slider-image" id="images" alt="responsive-image">
                        ...
                        <button type="button" class="btn btn-light hidden w-100 btn-custom" id="arrived" style="border: 2px solid black; border-radius: 10px; margin-bottom: 10px;">
                            <a class="h3 text-dark d-block" href="btsCIEL.php?idpage=FH1uxrm">Cliquez ici pour confirmer votre présence</a>
            ...
            <section class="row">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <section class="container">
                        <div class="cont-btn" style="margin: 0 10px;">
    ...
    <footer class="text-center text-lg-start text-white col-12 col col-md-12 col-lg-12" style="background-color: black; padding: 1%; margin:0; flex-direction: row;">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4" style="margin: auto;">
                <h6>Lycée <br> Polyvalent Rempart-Vinci <br> <br> 1 Rue de Rempart <br> 13007 Marseille <br> <a style="color: white;" href="tel:04 91 14 32 80"><h6>04 91 14 32 80</h6></a><br><a style="color: white;" href="https://www.site.ac-aix-marseille.fr/lyc-rempart/spip/">Site de l'établissement</a><br><br></h6>
            </div>
            <div class="col-12 col-md-6 col-lg-4" style="margin: auto;">
