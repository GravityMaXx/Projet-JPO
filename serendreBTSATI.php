...
<head>
    ...
    <title>Se rendre au BTS ATI</title> <!-- Titre de page -->
...
$message_erreur = "";
$page_origine = "serendreBTSATI.php?idpage=FH1uJk4";
if (isset($_GET["idpage"])) {
    $idpage = $_GET["idpage"];
    $url = $_SERVER['REQUEST_URI'];
    $erreur = "Erreur : Vous ne pouvez pas modifier L'url";
    $controle = "/serendreBTSATI.php?idpage=FH1uJk4"; // Notez l'ajout du slash pour la comparaison correcte du chemin
    if ($url != $controle) {
        ...
        <div class="container-fluid" style="margin-top: 20px;">
            ...
            <section class="row"> <!-- les trois éléments suivant seront répartis en rang [ELEM 1; ELEM 2; ELEM 3;]  -->
                ...
                <div class="slider col-12 col-md-12 col-lg-10" id="slider"> <!--ELEM 2 PREND 10 Colones lors ce que le ratio écran est 16/9, sinon toute la largeur dispo | SLIDER D'IMAGES -->
                    <section class="d-flex justify-content-center"> <!-- Aligner les éléments suivant au centre -->
                        ...
                        <img src="images/Orientation/GIFS/Orientation_ATI_1.gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <img src="images/Orientation/GIFS/Orientation_ATI_2 .gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <img src="images/Orientation/GIFS/Orientation_ATI_3 .gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <img src="images/Orientation/GIFS/Orientation_ATI_4 .gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <img src="images/Orientation/GIFS/Orientation_ATI_5 .gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <img src="images/Orientation/GIFS/Orientation_ATI_6 .gif" class="img-fluid slider-image" id="image" alt="responsive-image">
                        <button type="button" class="btn btn-light hidden w-100 btn-custom" id="arrived" style="border: 2px solid black; border-radius: 10px; margin-bottom: 10px;">
                            <a class="h3 text-dark d-block" href="btsATI.php?idpage=FH1uJk4">Cliquez ici pour confirmer votre présence</a>
            ...
            <div class="text-center" style="margin: auto;"> <!--- Création d'une section pour le bouton je suis perdu  -->
                <div class="d-flex justify-content-center">
                    <br>
                    <button type="button" class="btn btn-dark" id="loosed" style="border: 2px solid black; margin-top: 2%; margin-bottom: 5%;  border-radius: 10px; max-width: 80%;">
