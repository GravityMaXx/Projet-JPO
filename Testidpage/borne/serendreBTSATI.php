      ...
      <section class="row"> <!-- les trois éléments suivant seront répartis en rang [ELEM 1; ELEM 2; ELEM 3;]  -->
        ...
        <div class="slider col-12 col-md-12 col-lg-10" id="slider"> <!--ELEM 2 PREND 10 Colones lors ce que le ratio écran est 16/9, sinon toute la largeur dispo | SLIDER D'IMAGES -->
          <section class="d-flex justify-content-center"> <!-- Aligner les éléments suivant au centre -->
            <img src="images/Orientation/en_construction1.png" class="active img-fluid slider-image" id="images" alt="responsive-image"> <!--class active permet l'affichage -->
            <img src="images/Orientation/en_construction2.png" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/en_construction3.png" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/en_construction1.png" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/en_construction2.png" class="img-fluid slider-image" id="image" alt="responsive-image">
            <img src="images/Orientation/en_construction3.png" class="img-fluid slider-image" id="image" alt="responsive-image">
            ...
            <a class="h3 text-dark" href="btsATI.html"><h4>Je suis arrivé</h4></a></button> <!-- Bouton en fin de slider -->
          </section>
        </div>
