...
<?php
$message_erreur = "";
$page_origine = "/Testidpage/borne/serendreBTSCIEL.php?idpage=FH1uxrm";
if (isset($_GET["idpage"])) {
    $idpage = $_GET["idpage"];
    $url = $_SERVER['REQUEST_URI'];
    $erreur = "Erreur : Vous ne pouvez pas modifier L'url";
    $controle = "/Testidpage/borne/serendreBTSCIEL.php?idpage=FH1uxrm";
    if ($url != $controle) {
      ...
      <section class="row">
        ...
        <div class="slider col-12 col-md-12 col-lg-10" id="slider">
          <section class="d-flex justify-content-center">
            ...
            <a class="h3 text-dark" href="btsCIEL.html"><h4>Je suis arrivé</h4></a></button>
          </section>
        </div>
        <div class="col-0 col-md-0 col-lg-1">
          <section>
