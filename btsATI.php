...
<head>
    ...
    <title>La Formation : BTS ATI</title>
...
$message_erreur = "";
$page_origine = "btsATI.php?idpage=FH1uJk4";
if (isset($_GET["idpage"])) {
    $idpage = $_GET["idpage"];
    $url = $_SERVER['REQUEST_URI'];
    $erreur = "Erreur : Vous ne pouvez pas modifier L'url";
    $controle = "/btsATI.php?idpage=FH1uJk4"; // Notez l'ajout du slash pour la comparaison correcte du chemin
    if ($url != $controle) {
        ...
        <section class="row">
          <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="embed-responsive embed-responsive-16by9" style="border: 5px solid black; border-radius:5px;  background-color: black; margin-top: 2%;">
              <iframe class="embed-responsive embed-responsive-16by9" width="70%" src="https://www.youtube.com/embed/dp-kPyS5_6s" title="Témoignage d&#39;étudiants de BTS SNIR" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>Vidéo de témoignage</iframe>
            </div>
          </div>
            <br>
          <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="embed-responsive embed-responsive-16by9" style="border: 5px solid black; border-radius:5px; background-color: black; margin-top: 2%; justify-content: center;">
              <iframe class="embed-responsive embed-responsive-16by9" width="70%" src="https://www.youtube.com/embed/fk_DJxzG26g" title="HTML - Insérer une vidéo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>Vidéo de présentation</iframe>
            </div>
          </div>
        </section>
      </div>
      <br>
        <section class="row">
          ...
          <div class="col-10 col-md-8 col-lg-6">
            <a class="btn btn-dark text-white btn-lg btn-block responsive-width" href="https://www.site.ac-aix-marseille.fr/lyc-rempart/spip/spip.php?article23" style="margin: 2%; box-shadow: 0 5px 5px rgba(0, 0, 0, 0.6) ;"><h5 class="h5">En savoir d'avantage</h5></a>
            <br>
